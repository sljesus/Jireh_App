...
class _CompleteProfileWidgetState extends State<CompleteProfileWidget> {
  ...
  void initState() {
    ...
    _model.urPhoneController ??= TextEditingController();
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding: EdgeInsetsDirectional.fromSTEB(20.0, 0.0, 20.0, 16.0),
                child: TextFormField(
                  controller: _model.urPhoneController,
                  obscureText: false,
                  decoration: InputDecoration(
                    labelText: 'Tu número',
                    labelStyle: FlutterFlowTheme.of(context).bodySmall,
                  ...
                  maxLines: null,
                  validator:
                      _model.urPhoneControllerValidator.asValidator(context),
                ),
              ),
              Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      final userUpdateData = createUserRecordData(
                        ...
                        phoneNumber: _model.urPhoneController.text,
                        direccion: _model.addressController.text,
                        primerInicio: false,
                      );
                      await currentUserReference!.update(userUpdateData);
