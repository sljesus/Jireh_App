              ...
              appBar: PreferredSize(
                ...
                child: AppBar(
                  ...
                  flexibleSpace: FlexibleSpaceBar(
                    title: Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(30.0, 40.0, 16.0, 0.0),
                      child: Column(
                            ...
                            children: [
                              Row(
                                ...
                                children: [
                                  ...
                                  if (loggedIn && (menuCartRecord != null))
                              ...
                              if (loggedIn && (menuCartRecord != null))
                                Align(
                                  alignment: AlignmentDirectional(0.67, -1.48),
                                  child: InkWell(
                                    onTap: () async {
                                      context.pushNamed('Cart');
                                    },
                                    child: Text(
                                      menuCartRecord!.itemCount!.toString(),
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            fontFamily: 'Poppins',
                                          ...
                                          children: [
                                            FlutterFlowChoiceChips(
                                              options: [
                                                ChipData('⭐⭐⭐⭐⭐'),
                                                ChipData('Tamales'),
                                                ChipData('Chilaquiles'),
                                                ChipData('Tortas'),
                                                ChipData('Quesadillas'),
                                                ChipData('Desayunos'),
                                                ChipData('Atoles'),
                                                ChipData('Cafés'),
                                                ChipData('Nuevos')
                                  ...
                                  child: StreamBuilder<List<ItemsRecord>>(
                                    stream: queryItemsRecord(
                                      queryBuilder: (itemsRecord) =>
                                          itemsRecord.where('listacategorias',
                                              arrayContains:
                                                  _model.choiceChipsValue),
                                    ),
                                    builder: (context, snapshot) {
