...
import 'schema/percent_prices_record.dart';
...
export 'schema/percent_prices_record.dart';
...
/// Functions to query PercentPricesRecords (as a Stream and as a Future).
Future<int> queryPercentPricesRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      PercentPricesRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<PercentPricesRecord>> queryPercentPricesRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<List<PercentPricesRecord>> queryPercentPricesRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<PercentPricesRecord>> queryPercentPricesRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
